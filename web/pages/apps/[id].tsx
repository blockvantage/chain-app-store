        ...
        <section className="apple-section apple-gradient-blue py-12 px-6 md:px-12 rounded-apple-lg overflow-hidden relative animate-apple-fade-in">
          ...
          {app?.mockupImages && app.mockupImages.length > 0 && (
            <div className="absolute inset-0 overflow-hidden">
              ...
              <img 
                src={app.mockupImages[mockupImageIndex].imagePath ? `${process.env.NEXT_PUBLIC_BACKEND_URL || 'http://localhost:8080'}/images/${app.mockupImages[mockupImageIndex].imagePath}` : '/placeholder.png'}
                alt={`${app.name} mockup`}
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
            <div className="w-28 h-28 md:w-32 md:h-32 relative overflow-hidden rounded-apple-lg shadow-apple">
              {safe.get(app, 'logoPath', null) ? (
                <img 
                  src={safe.get(app, 'logoPath', '') ? `${process.env.NEXT_PUBLIC_BACKEND_URL || 'http://localhost:8080'}/images/${safe.get(app, 'logoPath', '')}` : '/placeholder.png'}
                ...
                <div className="bg-white dark:bg-neutral-900 rounded-apple-lg p-6 shadow-apple-sm space-y-6">
                  ...
                  <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
                    {app.mockupImages.map((image, index) => (
                      ...
                      >
                        <img 
                          src={image.imagePath ? `${process.env.NEXT_PUBLIC_BACKEND_URL || 'http://localhost:8080'}/images/${image.imagePath}` : '/placeholder.png'}
